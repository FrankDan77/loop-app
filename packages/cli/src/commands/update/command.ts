...
const ROLLING_DOWNLOAD_BASE =
	"https://github.com/FrankDan77/loop-app/releases/download/cli-latest";
...
function tarballUrl(target: string, version?: string): string {
	...
	return `https://github.com/FrankDan77/loop-app/releases/download/cli-v${version}/superset-${target}.tar.gz`;
}
