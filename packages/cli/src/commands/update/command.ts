...
const ROLLING_DOWNLOAD_BASE =
	"https://github.com/FrankDan77/loop/releases/download/cli-latest";
...
function tarballUrl(target: string, version?: string): string {
	...
	return `https://github.com/FrankDan77/loop/releases/download/cli-v${version}/superset-${target}.tar.gz`;
}
