...
[![GitHub stars](https://img.shields.io/github/stars/FrankDan77/loop?style=flat&logo=github)](https://github.com/FrankDan77/loop/stargazers)
[![GitHub release](https://img.shields.io/github/v/release/FrankDan77/loop?style=flat&logo=github)](https://github.com/FrankDan77/loop/releases)
[![License](https://img.shields.io/github/license/FrankDan77/loop?style=flat)](LICENSE.md)
...
[**Download for macOS**](https://github.com/FrankDan77/loop/releases/latest) &nbsp;&bull;&nbsp; [Documentation](https://docs.superset.sh) &nbsp;&bull;&nbsp; [Changelog](https://github.com/FrankDan77/loop/releases) &nbsp;&bull;&nbsp; [Discord](https://discord.gg/cZeD9WYcV7)
...
|:--------|:-------------|
| [**Desktop App**](https://github.com/FrankDan77/loop/releases/latest) | The full IDE: terminals, diff viewer, in-app browser, automations |
...
**[Download Superset for macOS](https://github.com/FrankDan77/loop/releases/latest)**
...
We welcome contributions! See [CONTRIBUTING.md](CONTRIBUTING.md) for how to get set up and open a PR. Bugs and feature requests go in [issues](https://github.com/FrankDan77/loop/issues).

<a href="https://github.com/FrankDan77/loop/graphs/contributors">
