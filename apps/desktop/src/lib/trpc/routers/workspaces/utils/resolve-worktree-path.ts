...
import { LOOP_DIR_NAME, WORKTREES_DIR_NAME } from "shared/constants";

/** Resolves base dir: project override > global setting > default (~/.loop/worktrees) */
export function resolveWorktreePath(
	...
	const baseDir =
		row?.worktreeBaseDir ?? join(homedir(), LOOP_DIR_NAME, WORKTREES_DIR_NAME);
