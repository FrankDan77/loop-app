...
export const PRO_FEATURES: ProFeature[] = [
	{
		...
		description:
			"Reach this Mac from anywhere via the Loop relay, or spin up cloud workspaces. Connect from any client.",
	...
	},
	{
		...
		title: "Tasks",
		description:
			"Track and manage tasks synced from Linear. Stay on top of your work without leaving Loop.",
