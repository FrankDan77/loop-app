...
const config: Configuration = {
	...
	// Disabled: native modules are already built during copy:native-modules step
	npmRebuild: false,
	...
	mac: {
		...
		extendInfo: {
			...
			NSMicrophoneUsageDescription:
				"Loop needs microphone access so voice-enabled tools like Codex transcription can capture audio input.",
			// Required for macOS local network permission prompt
			NSLocalNetworkUsageDescription:
				"Loop needs access to your local network to discover and connect to development servers running on your network.",
			...
			NSAppleEventsUsageDescription:
				"Loop needs to interact with other applications to run terminal commands and development tools.",
		},
	},
	...
	linux: {
		...
		target: ["AppImage"],
		artifactName: `loop-\${version}-\${arch}.\${ext}`,
	},
